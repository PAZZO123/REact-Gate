/*Create a 2 steps form component. 

- First step will have:
    - A header displaying `Step 1. Provide email`
    - An input for the user to enter the email
    - A button to go to the next step (while maintaining the state)
- Second step will have:
    - A header displaying `Step 2. Provide passowrd`
    - An input for the user to enter the password
    - A button to go to the previous step (while maintaining the state)
    - A button to submit the form
- Upon submission, you will just display the data and clear both inputs

This component uses only React to simulate this kind of navigation.

The UI is already handled just focus on the logic. */
...
const TwoStepForm = () => {
  ...
  const handleSubmit = () => {
    setSubmittedData({ email:formData.email,password:formData.password})
